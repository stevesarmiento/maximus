...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-[16px] bg-transparent px-4 py-2 text-nav-item hover:bg-sand-1300/50 hover:text-accent-foreground focus:bg-sand-1300/50 focus:text-accent-foreground disabled:pointer-events-none disabled:opacity-50 data-[state=open]:hover:bg-sand-1300/50 data-[state=open]:text-accent-foreground data-[state=open]:focus:bg-sand-1400 data-[state=open]:bg-sand-1300 focus-visible:ring-ring/50 outline-none transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1"
)
...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "data-[active=true]:focus:bg-sand-1400 data-[active=true]:hover:bg-sand-1400 data-[active=true]:bg-sand-1400/50 data-[active=true]:text-accent-foreground hover:bg-sand-1400 hover:text-accent-foreground focus:bg-sand-1400 focus:text-accent-foreground focus-visible:ring-ring/50 [&_svg:not([class*='text-'])]:text-muted-foreground flex flex-col gap-1 rounded-sm p-2 text-sm transition-all outline-none focus-visible:ring-[3px] focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
